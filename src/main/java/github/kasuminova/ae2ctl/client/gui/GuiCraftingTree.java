...
import github.kasuminova.ae2ctl.client.gui.widget.Button4State;
import github.kasuminova.ae2ctl.client.gui.widget.Button5State;
import github.kasuminova.ae2ctl.client.gui.widget.MultiLineLabel;
...
public class GuiCraftingTree extends AEBaseGuiContainerDynamic {
    ...
    public GuiCraftingTree(final InventoryPlayer inventoryPlayer, final ITerminalHost te) {
        ...
        this.widgetController.addWidget(back
                ...
                .setOnClickedListener(btn -> AE2CTLegacy.NET_CHANNEL.sendToServer(new PktSwitchCraftingTree()))
                .setWidthHeight(24, 20)
                .setAbsXY(xSize - 30, 3));
    }
