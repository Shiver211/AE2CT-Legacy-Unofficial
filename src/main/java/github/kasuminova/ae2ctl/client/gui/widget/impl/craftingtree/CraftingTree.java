...
import github.kasuminova.ae2ctl.client.gui.widget.container.Row;
import github.kasuminova.ae2ctl.client.gui.widget.event.GuiEvent;
import github.kasuminova.ae2ctl.client.gui.widget.SizedColumn;
    ...
    protected void postRenderInternal(final WidgetGui gui, final RenderSize renderSize, final RenderPos renderPos, final MousePos mousePos) {
        ...
        if (selected == null) {
            fr.drawStringWithShadow(
                    String.format("Rendered Nodes: %s / %s", DEBUG_RENDERED_NODES.getAndSet(0), nodes),
